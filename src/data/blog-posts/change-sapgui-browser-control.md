...
### 重启 SAPGUI
如果你的修改并未生效，尝试重启 SAPGUI 应用程序，使更改生效。

### 验证修改
打开 SAP GUI 并访问之前显示异常的网站，检查是否正常显示。如果问题已解决，说明修改成功。

### 注意事项
- 修改浏览器控制选项后，SAP GUI 可能会重新启动，需要重新登录。

### SAP GUI 下载地址
- [SAP GUI 下载]( https://pan.baidu.com/s/1eYbAEXOHHOTd04kSruDu5w?pwd=9ye9)

SAPGui安装包: win默认装尾号342程序，详阅README
SAPGui安装和配置说明 链接：https://www.123865.com/s/0LFGvd-lSbP3
