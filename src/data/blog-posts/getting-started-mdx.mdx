...
<img src="https://i.kiksoft.net/weGroup.jpg" alt="SAP 用户交流群" onerror="this.onerror=null;this.src=this.src.replace(/\.jpg$/, '.png');this.onerror=function(){this.onerror=null;this.src=this.src.replace(/\.png$/, '.jpeg');}" style="width: 40%; float: right; margin-left: 20px; margin-bottom: 20px;" />
